...
CustomWidget::CustomWidget(QWidget *parent, QList<Shellcode> shellcodes)
    : QWidget(parent), shellcodes(shellcodes) {
  ...
  connect(m_widget, SIGNAL(itemDoubleClicked(QListWidgetItem *)), this,
